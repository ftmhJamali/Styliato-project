            ...
            <svg viewBox="0 0 100 100" preserveAspectRatio="xMidYMid slice">
                <defs>
                    <radialGradient id="Gradient1" cx="50%" cy="50%" fx="0.441602%" fy="50%" r=".5">
                        ...
                        <stop offset="0%" stopColor="rgba(255, 0, 116, 0.9)"></stop>
                        <stop offset="100%" stopColor="rgba(255, 0, 116, 0)"></stop>
                    </radialGradient>
                    <radialGradient id="Gradient2" cx="50%" cy="50%" fx="2.68147%" fy="50%" r=".5">
                        <animate attributeName="fx" dur="23.5s" values="0%;3%;0%"
                                 repeatCount="indefinite"></animate>
                        <stop offset="0%" stopColor="rgb(255, 136, 0)"></stop>
                        <stop offset="100%" stopColor="rgb(255, 136, 0, 0)"></stop>
                    </radialGradient>
                    <radialGradient id="Gradient3" cx="50%" cy="50%" fx="0.836536%" fy="50%" r=".5">
                        <animate attributeName="fx" dur="21.5s" values="0%;3%;0%"
                                 repeatCount="indefinite"></animate>
                        <stop offset="0%" stopColor="rgb(255, 0, 68)"></stop>
                        <stop offset="100%" stopColor="rgb(255, 0, 68, 0)"></stop>
                    </radialGradient>
                    <radialGradient id="Gradient4" cx="50%" cy="50%" fx="4.56417%" fy="50%" r=".5">
                        <animate attributeName="fx" dur="23s" values="0%;5%;0%" repeatCount="indefinite"></animate>
                        <stop offset="0%" stopColor="rgb(255, 68, 0)"></stop>
                        <stop offset="100%" stopColor="rgb(255, 68, 0, 1)"></stop>
                    </radialGradient>
